...
var score;
var gameOverImg,restartImg,jumpImage
...
function setup() {
 ...
 console.log(message)
  ...
  //trex.debug = true
  jump=createSprite(200,50,20,20);
...
function draw() {
  ...
  if(gameState === PLAY){
    ...
    if(keyDown("space")&& trex.y >= 100 || mousePressedOver(jump)&& trex.y >= 100) {
        trex.velocityY = -12;
        jumpSound.play();
    }
